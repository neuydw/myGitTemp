...
from basepage import BasePage  # 脚本需要用到BasePage类中的自定义方法，可左ctrl+鼠标左键点击查看
from nk_locator import *  # 引用此脚本对应的xpath定位信息
from nk_data import NkData  # 引用此脚本对应的测试数据信息
import allure  # @allure修饰器 ，allure报告引用需要


@allure.description("服务事项维护模块新增功能")  # 对应allure报告描述信息
@allure.feature("服务事项维护模块")  # 对应allure报告模块名称
@pytest.mark.ywgfszlc(reruns=3, reruns_delay=2)
